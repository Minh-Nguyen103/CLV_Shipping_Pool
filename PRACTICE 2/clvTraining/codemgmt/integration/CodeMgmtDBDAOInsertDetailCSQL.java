...
*@FileName : CodeMgmtDBDAOInsertDetailCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CodeMgmtDBDAOInsertDetailCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CodeMgmtDBDAOInsertDetailCSQL(){
		setQuery();
		...
		query.append("FileName : CodeMgmtDBDAOInsertDetailCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
