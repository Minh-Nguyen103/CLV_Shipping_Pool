...
*@FileName : CarrierMgmtDBDAOInsertCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierMgmtDBDAOInsertCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierMgmtDBDAOInsertCSQL(){
		setQuery();
		...
		query.append("FileName : CarrierMgmtDBDAOInsertCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
