...
*@FileName : NYN_PRACTICE_0001HTMLAction.java
...
/**
 * HTTP Parser<br>
 * - com.clt.apps.opus.esm.clvtraining 화면을 통해 서버로 전송되는 HTML DOM 객체의 Value를 자바 변수로 Parsing<br>
...
public class NYN_PRACTICE_0001HTMLAction extends HTMLActionSupport {

	private static final long serialVersionUID = 1L;
	/**
	 * NYN_PRACTICE_0001HTMLAction 객체를 생성
	 */
	public NYN_PRACTICE_0001HTMLAction() {}
	...
	public Event perform(HttpServletRequest request) throws HTMLActionException {
		...
		NynPractice0001Event event = new NynPractice0001Event();
