...
*@FileName : NYN_PRACTICE_0001.jsp
...
<%@ page import="com.clt.apps.opus.esm.clvtraining.errmsgmgmt.event.NynPractice0001Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	NynPractice0001Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		...
		event = (NynPractice0001Event)request.getAttribute("Event");
